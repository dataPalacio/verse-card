...
from sistema.pipeline.validacao import ErroDeConteudo, valida_arquivo, valida_conteudo

RAIZ = Path(__file__).resolve().parent.parent.parent
REAL = RAIZ / "conteudos" / "exemplos" / "proverbios-19-21.json"
EXEMPLO = RAIZ / "conteudos" / "exemplos" / "exemplo-minimo.json"

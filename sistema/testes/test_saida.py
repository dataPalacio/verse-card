...
from sistema.pipeline.render import caminho_arte, prepara_saida
...
def test_arte_vai_para_a_subpasta_do_formato():
    assert caminho_arte(1, {"formato": "feed"}) == "feed/slide-01.png"
    assert caminho_arte(2, {"formato": "story"}) == "story/slide-02.png"


def test_indice_recebe_dois_digitos():
    assert caminho_arte(7, {"formato": "feed"}).endswith("slide-07.png")
    assert caminho_arte(10, {"formato": "feed"}).endswith("slide-10.png")


def test_formato_ausente_assume_feed():
    assert caminho_arte(1, {}) == "feed/slide-01.png"
...
def test_run_que_encolhe_nao_deixa_arte_obsoleta(tmp_path):
    ...
    assert pngs(tmp_path) == ["feed/slide-01.png",
                              "feed/slide-02.png",
                              "feed/slide-03.png"]

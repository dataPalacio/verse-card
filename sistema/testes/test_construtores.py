...
from sistema.pipeline.construtores import (LIMITE_LIVRO_LONGO, bloco_foto, bloco_passagem,
...
def test_slide_emite_exatamente_um_selo():
    # trava a Regra 1 de regras/identidade-visual.md em nivel unitario,

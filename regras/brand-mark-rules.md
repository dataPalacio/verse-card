...
**Asset canônico:** `marca/logo-marca-warm-earth.png` (512×512, PNG transparente, traço em `#5C3D1E`)
**Derivado:** `marca/logo-base64.txt` — gerado do PNG por `.\executar.ps1 -Acao sincronizar`. Não editar à mão.
...
Valores conforme `template/verse-card.css`:
